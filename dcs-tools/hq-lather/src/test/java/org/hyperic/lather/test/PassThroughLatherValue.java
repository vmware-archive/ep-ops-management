            ...
            extends LatherValue
{
    ...
    public void setByteAValue(String key,
                              byte[] value) {
        super.setByteAValue(key, value);
    }

    public void addStringToList(String listName,
                                String value) {
    ...
    public void addIntToList(String listName,
                             int value) {
    ...
    public void addDoubleToList(String listName,
                                double value) {
    ...
    public void addByteAToList(String listName,
                               byte[] value) {
    ...
    public void setObjectValue(String key,
                               LatherValue value) {
    ...
    public void addObjectToList(String listName,
                                LatherValue value) {
