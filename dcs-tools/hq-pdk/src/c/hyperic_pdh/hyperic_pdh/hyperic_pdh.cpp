...
static char *get_error_message(PDH_STATUS status) {
	...
	case PDH_CSTATUS_BAD_COUNTERNAME:
		return "The counter name path string could not be parsed or interpreted";
	...
	case PDH_FUNCTION_NOT_FOUND:
		return "The calculation function for this counter could not be determined";
...
JNIEXPORT jlong JNICALL Java_org_hyperic_hq_pdh_MultipleCollectQueryPdh_pdhOpenQuery(JNIEnv *env, jclass jc) {
	HQUERY     h_query;
	PDH_STATUS status;
...
JNIEXPORT jlong JNICALL Java_org_hyperic_hq_pdh_MultipleCollectQueryPdh_pdhAddCounter(JNIEnv *env, jclass, jlong query, jstring path) {
	HCOUNTER   h_counter;
...
JNIEXPORT void JNICALL Java_org_hyperic_hq_pdh_MultipleCollectQueryPdh_pdhRemoveCounter(JNIEnv *env, jclass, jlong counter) {
...
JNIEXPORT void JNICALL Java_org_hyperic_hq_pdh_MultipleCollectQueryPdh_PdhCollectQueryData(JNIEnv * env, jclass, jlong query) {
	HQUERY h_query = (HQUERY)query;
...
JNIEXPORT jdouble JNICALL Java_org_hyperic_hq_pdh_MultipleCollectQueryPdh_PdhGetFormattedCounterValue(JNIEnv *env, jclass, jlong counter) {
	HCOUNTER  h_counter = (HCOUNTER)counter;
...
JNIEXPORT jobjectArray JNICALL Java_org_hyperic_hq_pdh_MultipleCollectQueryPdh_pdhGetInstances(JNIEnv *env, jclass, jstring cp) {
