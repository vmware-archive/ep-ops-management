...
/**
 * Base class for driving local tests of plugins. Takes care of setting sigar home (assuming you have unpacked
 * sigar-libs into target/generated-test-resources), creates a tmp plugin jar from your plugin source code, and
 * registers that plugin jar with the PluginManagers, thus fully creating your plugin as would be done in the agent
 * (including initialization of PluginData from the plugin XML)
 * 
 * @author jhickey
 * 
 */
abstract public class BasePluginIntegrationTest {
    ...
    static final String HQ_IP = AgentConfig.QPROP_IPADDR;
    static final String HQ_SSLPORT = AgentConfig.QPROP_SSLPORT;
    static final String HQ_USER = AgentConfig.QPROP_LOGIN;
    static final String HQ_PASS = AgentConfig.QPROP_PWORD;
    ...
    public void registerPlugin()
        ...
        agentProps.put(HQ_SSLPORT, "8080");
    ...
    /**
     * Creates a plugin jar in the tmp dir containing everything in target/classes and using the project name to name
     * the jar
     * 
     * @throws IOException
     */
    @BeforeClass
    public static void createPluginJar()
        throws IOException {
    ...
    /**
     * Registers the sigar path as the location in the classpath to which the sigar libs have been unpacked
     * 
     * @throws IOException
     */
    @BeforeClass
    public static void registerSigarLib()
        throws IOException {
