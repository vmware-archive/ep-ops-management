...
public class ServerDetectorTest
{
    ...
    @Test
    public void testMatchAndNoMatchOnSameString()
        throws Exception {
        assertNotNull(tmpDir);
        assertNotNull(simpleFile);
    ...
    @Test
    public void testMatchAndNoMatchOnDifferentStrings()
        throws Exception {
        assertNotNull(tmpDir);
        assertNotNull(simpleFile);
    ...
    @Ignore("I/O Error working with tmp dir on CI machine")
    @Test
    public void testRecursiveNoMatch()
        throws Exception {
        assertNotNull(tmpDir);
        assertNotNull(deepFile);
    ...
    @Test
    public void testNullVersionFile()
        throws Exception {
        assertNotNull(tmpDir);
        assertNotNull(simpleFile);
