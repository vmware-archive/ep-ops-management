...
/**
 * Encapsulates the global configuration information about an auto-inventory scan. By global, we mean the scan config
...
public class ScanConfiguration {
     ...
     * 
     * @return An Iterator over a collection of Strings, each of which is a java class name of a class that implements
     *         the ScanMethod interface.
     */
     ...
     * @param config The configuration information to use when configuring the scan method at scan-time.
     */
     ...
     * 
     * @param scanMethod The ScanMethod to retrieve configuration information from.
     * @return The ConfigResponse configuration information to use when configuring the scan method at scan-time.
     */
    public ConfigResponse getScanMethodConfig(ScanMethod scanMethod) {
        ScanMethodConfig methodConfig = _core.findScanMethodConfig(scanMethod);
     ...
     * Get the configuration for a single scan method.
     * 
     * @param scanMethodName The name of the ScanMethod to retrieve configuration information from.
     * @return The ConfigResponse configuration information to use when configuring the scan method at scan-time.
     */
    public ConfigResponse getScanMethodConfig(String scanMethodName) {
        ScanMethodConfig methodConfig = _core.findScanMethodConfig(scanMethodName);
        return methodConfig.getConfig();
    }
     ...
     * 
     * @return An array of ServerSignature objects indicating which servers to scan for.
     */
     ...
     * 
     * @param serverSigs An array of ServerSignature objects indicating which server types to scan for.
     */
    ...
    public String toString() {
        if (_core == null) {
            ...
            return "Sync scan: " + isSyncScan() + "\n" +
                        "Default scan: " + getIsDefaultScan() + "\n" +
                        _core.toString();
        }
    }
