 ...
 * 
 * - The agent will perform regular AI runtime scans, filling out a {@link CompositeRuntimeResourceReport}. - Then, the
 * report is sent to a this filter - Then, the report is examined and we check if it is the same as the last runtime
 * report we sent. If it is, we don't send it, else we do.
 */
