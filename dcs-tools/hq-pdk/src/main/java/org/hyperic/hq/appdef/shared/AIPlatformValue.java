            ...
            implements java.io.Serializable
{
    ...
    public String toString()
    {
        ...
        str.append("agentToken=" + getAgentToken() + " " + "queueStatus=" + getQueueStatus() + " "
                    + "customProperties=" + getCustomProperties() + " " + "productConfig=" + getProductConfig() + " "
                    + "controlConfig=" + getControlConfig() + " " + "measurementConfig=" + getMeasurementConfig() + " "
                    + "diff=" + getDiff() + " " + "ignored=" + getIgnored() + " " + "platformTypeName="
                    + getPlatformTypeName() + " " + "lastApproved=" + getLastApproved() + " " + "certdn=" + getCertdn()
                    + " " + "fqdn=" + getFqdn() + " " + "name=" + getName() + " " + "location=" + getLocation() + " "
                    + "description=" + getDescription() + " " + "cpuCount=" + getCpuCount() + " " + "id=" + getId()
