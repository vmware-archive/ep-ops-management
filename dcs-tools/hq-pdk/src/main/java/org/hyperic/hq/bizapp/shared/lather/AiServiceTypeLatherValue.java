...
/**
 * Represents a service type in data types that can be transferred from agent to server via Lather, as would be defined
 * by a <service> XML tag
 * 
 * @author jhickey
 * 
 */
public class AiServiceTypeLatherValue extends AiLatherValue {
    ...
    /**
     * Constructs a new {@link AiServiceTypeLatherValue} from the specified service type
     * 
     * @param serviceType The service type to obtain information from
     */
     ...
     * 
     * @return An {@link AIServiceTypeValue} containing properties from this class
     */
