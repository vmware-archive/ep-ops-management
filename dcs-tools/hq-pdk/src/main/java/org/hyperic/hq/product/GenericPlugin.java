...
public abstract class GenericPlugin {
     ...
     * @return List of String file names, which are trimmed and have unescaped any embedded commas ("%2C" -> ",")
     */
    ...
    /**
     * Get all properties defined using &lt;property&gt; within the resource tag (platform|server|service) for this
     * type.
     */
    ...
    /**
     * Get a value defined by a &lt;property&gt; tag in the plugin's hq-plugin.xml, within a &lt;server&gt; or
     * &lt;service&gt; tag for this plugin's type.
     * <p>
     * Same as: <code>
    ...
    /**
     * If name property is not found for the given type, try using the type's parent. If not found using parent's type,
     * try using top-level properties from hq-plugin.xml.
     */
    ...
    /**
     * Called when the server or agent is shutdown. Use this method to cleanup any resources that were created during
     * the init() method.
     * 
     * @throws PluginException
     */
    ...
    public String getDefaultInstallPath() {
        return ProductPlugin.DEFAULT_INSTALLPATH +
                    File.separator +
