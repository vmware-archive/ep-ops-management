...
public abstract class RtPlugin extends GenericPlugin {
    ...
    private void getTransforms(String transforms,
                               ArrayList patterns,
                               ArrayList subs)
    {
     ...
     */
    private void transformUrl(RtStat rs,
                              String transforms)
    {
        ...
        for (Iterator p = patterns.iterator(), s = subs.iterator(); (p.hasNext() && s.hasNext());) {
     ...
     * 
     * @param is - an input stream of a webapps web.xml where this filter is defined
