...
/**
 * Base class for windows event notifications. This handles parsing the event record and sending it to HQ. All plugins
 * sould subclass this class if they need to override the standard matches() function in the base class.
 */
