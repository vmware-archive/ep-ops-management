...
public final class AICommandsAPI extends AgentAPIInfo {
    ...
    public static final String command_startScan = commandPrefix + "startScan";
    public static final String command_stopScan = commandPrefix + "stopScan";
    public static final String command_getScanStatus = commandPrefix + "getScanStatus";
    public static final String command_pushRuntimeDiscoveryConfig = commandPrefix + "pushRuntimeDiscoveryConfig";
