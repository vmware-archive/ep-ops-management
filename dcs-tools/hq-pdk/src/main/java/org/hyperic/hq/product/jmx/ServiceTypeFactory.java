...
public class ServiceTypeFactory {
    ...
    /**
     * Creates a Set of ServiceTypes from a Set of Services, ignoring multiple services of the same ServiceType
     * (determined by fully qualified service type name)
     * 
     * @param productPlugin The plugin of the product containing this service type
     * @param serverType The type of service containing this service type
     * @param mServer
     * @param serviceInfo The unique info of the service type
     * @param objectNames The {@link ObjectName}s of the associated services whose metadata is to be inspected
     ...
     * @param serverType The type of service containing this service type
     * @param serviceInfo The unique info of the service type
     * @param objectName The {@link ObjectName} of the associated service whose metadata is to be inspected
     * @return The created {@link ServiceType} or null if it could not be created
     */
    ...
    /**
     * Returns a ServiceType containing ONLY the properties needed at construction time (the ones that guarantee
     * uniqueness)
     * 
     ...
     * @return A ServiceType containing ONLY the properties needed at construction time (the ones that guarantee
     *         uniqueness)
     */
