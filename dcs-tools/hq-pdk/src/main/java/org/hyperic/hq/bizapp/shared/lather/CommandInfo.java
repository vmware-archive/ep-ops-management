...
/**
 * Commands from Agent to Server
 * 
 */
public class CommandInfo {
    public static final String CMD_SERVER_INFO = "serverInfo";
    ...
    public static final String CMD_GET_AGENT_COMMANDS = "getAgentCommands";
    public static final String CMD_SEND_RESPONSE = "sendCommandsResponse";
    public static final String CMD_GET_DISABLED_PLUGINS = "getDisabledPlugins";
    ...
    public static final String[] ALL_COMMANDS = {
                ...
                CMD_GET_AGENT_COMMANDS,
                CMD_SEND_RESPONSE,
                CMD_GET_DISABLED_PLUGINS
    };
