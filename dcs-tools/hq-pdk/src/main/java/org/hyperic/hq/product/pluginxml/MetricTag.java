...
class MetricTag
    ...
    public void handleUnknownAttribute(String name,
                                       String value) {
    ...
    /**
     * Generic method for creating a new MeasurementInfo instance, filling in class fields using given attributes Map.
     */
    ...
    private XmlAttrException invalidAttr(String attr,
                                         String val) {
