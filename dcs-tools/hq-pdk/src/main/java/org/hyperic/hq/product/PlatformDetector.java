...
public class PlatformDetector extends GenericPlugin {
    ...
    public static final String[] UNIX_PLATFORM_NAMES = SupportedOperatingSystem.getSupportedUnixPlatforms().toArray(
                EMPARR);
    public static String[] WIN32_PLATFORM_NAMES = SupportedOperatingSystem.getSupportedWindowsPlatforms().toArray(
                EMPARR);
    ...
    private String getValue(ConfigResponse config,
                            String key)
