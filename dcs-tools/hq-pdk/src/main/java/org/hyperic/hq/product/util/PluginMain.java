...
public class PluginMain {
    ...
    private static URL jarURL(String jar)
        throws Exception {
        return new URL("jar", null, "file:" + jar + "!/");
    }

    private static URL[] getLibJars(String dir)
        throws Exception {
    ...
    private static void addVersionFile(String pdkDir)
        throws Exception {
    ...
    private static void addURLs(URL[] jars)
        throws Exception {
    ...
    private static void addJarDir(String dir)
        throws Exception {
    ...
    private static void configureLogging(String pdkDir,
                                         String level) {
        ...
        for (Iterator it = agentProps.keySet().iterator(); it.hasNext();)
        {
