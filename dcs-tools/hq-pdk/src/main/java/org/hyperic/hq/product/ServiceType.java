...
/**
 * Representation of a service type, equivalent to the data specified by the <service> XML tag
 * 
 * @author jhickey
 * 
 */
public class ServiceType {
    ...
    /**
     * 
     * @param serviceName The unique service type name (unique with respect to server type)
     * @param productName The name of the product containing this service
     * @param info The {@link ServiceTypeInfo} describing this service type
     */
     ...
     * 
     * @param controlAction The name of the control action to add
     */
    ...
    /**
     * 
     * @return The plugins for this service type. Key of properties map is plugin type (i.e. "control"), value is fully
     *         qualified class name of plugin
     */
    ...
    /**
     * 
     * @return The properties of this service type (the ones used internally). This is equivalent to the direct
     *         <property> tag in the service XML (as opposed to the <properties> tag which defines custom properties).
     */
    ...
    /**
     * 
     * @param controlActions The set of control action names for this {@link ServiceType}
     */
    ...
    /**
     * 
     * @param customProperties The custom properties for this {@link ServiceType}
     */
    ...
    /**
     * 
     * @param measurements The measurements for this service type
     */
    ...
    /**
     * 
     * @param pluginClasses The plugins for this service type. Key of properties map is plugin type (i.e. "control"),
     *            value is fully qualified class name of plugin
     */
    ...
    /**
     * 
     * @param properties The properties of this service type (the ones used internally). This is equivalent to the
     *            direct <property> tag in the service XML (as opposed to the <properties> tag which defines custom
     *            properties).
     */
