...
public interface ScanMethod {
    ...
    /**
     * Get the authority level of this ScanMethod. ScanMethods with higher authority levels are considered authoritative
     * for server and service attributes when multiple ScanMethods detect the same server/service.
     * 
    ...
    /**
     * Set the authority level of this ScanMethod. ScanMethods with higher authority levels are considered authoritative
     * for server and service attributes when multiple ScanMethods detect the same server/service.
     * 
     ...
     * 
     * @return A config schema that determines how this scan method is configured.
     * @exception AutoinventoryException If there is an error generating the configuration option list.
     */
