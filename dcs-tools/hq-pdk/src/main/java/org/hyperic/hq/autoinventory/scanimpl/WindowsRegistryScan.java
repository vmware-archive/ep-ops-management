...
/**
 * This implementation of ScanMethod knows how to scan the Windows Registry. It can be configurated to scan the whole
 * registry or only certain keys while ignoring others.
 */
public class WindowsRegistryScan extends ScanMethodBase {
    ...
    public void scan(ConfigResponse platformConfig,
        ...
        for (Iterator it = detectorMap.entrySet().iterator(); it.hasNext();)
        {
