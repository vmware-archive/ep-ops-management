...
/**
 * This class is for use by plugin managers to maintain information about a plugin in order to remove/update a plugin
 * jar.
 */
...
public class PluginInfo implements java.io.Serializable {
    ...
    private String getMD5(ProductPlugin plugin,
                          String jar)
        throws IOException {
    ...
    public boolean matches(PluginInfo info) {
        return this.md5.equals(info.md5) &&
