...
/**
 * This class just encapsulates the "raw data" part of the scan configuration, without any utility methods or other
 * flim-flam. It exists to make it easy to move scan configurations across SOAP and other network transports.
 */
public class ScanConfigurationCore implements Serializable {
    ...
    /**
     * An array of ServerSignature objects representing the servers to scan for.
     */
     ...
     * 
     * @param serverTypes An array of ServerSignature objects indicating which server types to scan for.
     */
     ...
     * 
     * @param keyName The key name to use when populating the AgentRemoteValue with data.
     * @param arv The AgentRemoteValue to write.
     * @exception AutoinventoryException If a problem occurs populating the AgentRemoteValue with data.
     */
     ...
     * 
     * @param keyName The key name to use when reading data from the AgentRemoteValue.
     * @param arv The AgentRemoteValue to read.
     * @return A ScanConfiguration object read from the AgentRemoteValue.
     * @exception AutoinventoryException If a problem occurs reading data from the AgentRemoteValue.
     */
