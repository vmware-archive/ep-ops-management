...
public class ServerResource {
    ...
    /**
     * This attribute should only be set if discovered server is hosted on a platform other than the platform which ran
     * the auto discovery. The WebLogic plugin for example may find cluster nodes on other platforms. Note that setting
     * this attribute will also require the given platform to exist in the HQ inventory.
     */
