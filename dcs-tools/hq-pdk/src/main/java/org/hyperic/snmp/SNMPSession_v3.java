 ...
 * only different from v1 or v2c in the way that a session is initialized.
 */
            ...
            extends SNMPSession_v2c
{
    ...
    /**
     * Remote SNMPv3 engines will send back a Report PDU if there is a problem with the request.
     */
    protected void validateResponsePDU(String name,
                                       PDU response)
        throws SNMPException {
