...
public class KeystoreManagerTest {
    ...
    /**
     * 1. test create keystore (hq default) pre-condition: no keystore post-cond:
     * keystore("test_HQ","testKeystore","111111") is created
     */
    @Test
    ...
    /**
     * 2. test custom config keystore pre-condition: no keystore post-cond: IOException - can't find the keystore
     */
    @Test
    ...
    /**
     * 1. test create keystore (hq default) pre-condition: keystore("test_HQ","testKeystore","111111") post-cond:
     * keystore("test_HQ","testKeystore","111111"), no exception thrown
     */
    @Test
