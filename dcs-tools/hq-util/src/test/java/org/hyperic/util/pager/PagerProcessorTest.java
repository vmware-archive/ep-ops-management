...
public class PagerProcessorTest extends TestCase {

    public PagerProcessorTest() {
        super("PagerProcessor_test");
    }

    public PagerProcessorTest(String s) {
        super(s);
    }
    ...
    public void validateCorrectResults(String msg,
                                       List results,
                                       int[] expected) {
