...
/**
 * A thread group that a client may use for registering an action to perform if an uncaught exception is handled. The
 * uncaught exception may also be retrieved.
 */
