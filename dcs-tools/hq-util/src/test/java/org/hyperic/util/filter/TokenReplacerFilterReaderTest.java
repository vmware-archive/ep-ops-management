...
public class TokenReplacerFilterReaderTest extends TestCase {

    public TokenReplacerFilterReaderTest()
    {
        this("TokenReplacerFilterReader_test");
    }

    public TokenReplacerFilterReaderTest(String name)
    {
        super(name);
    }

    public void testValidStringReplacement()
        throws Exception
    {
    ...
    public void testInvalidStringReplacement()
        throws Exception
    {
        char buf[] = new char[1024];
    ...
    public static void main(String[] args) {
        try {
            TokenReplacerFilterReaderTest pr =
                        new TokenReplacerFilterReaderTest("main");
