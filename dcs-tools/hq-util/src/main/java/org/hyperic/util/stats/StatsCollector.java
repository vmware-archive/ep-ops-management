...
/**
 * The StatsCollector is a class used to calculate metrics based on a series of events. Events consist of a value and a
 * timestamp.
 * 
...
public class StatsCollector {
    ...
    /**
     * Add a value to the collection. Old values will be evicted from the collection if the addition would exceed the
     * internal size.
     */
