...
/**
 * Polls a set of files or directories for changes and notifies registered listeners
 * 
 * @author jhickey
 * @author rladdad
 * 
...
public class FileWatcher {
    ...
    private void addFileOrDir(String fileOrDir,
                              boolean watchSubtrees) {
    ...
    /**
     * 
     * @param checkInterval The polling interval. This method has no effect if called after start
     */
