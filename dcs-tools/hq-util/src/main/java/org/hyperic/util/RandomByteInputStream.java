...
/**
 * A <code>RandomByteInputStream</code> supplies random bytes corresponding to the ascii character range that may be
 * read from the stream. It has an associated size and maintains an internal counter to test whether the end of the
 * stream is reached during a <code>read</code> operation.
 * <p>
 * Closing a <tt>RandomByteInputStream</tt> has no effect. The methods in this class can be called after the stream has
...
public class RandomByteInputStream extends InputStream {
    ...
    /**
     * The index of the next character to read from the input stream buffer. This value should always be nonnegative and
     * not larger than the value of <code>count</code>.
     */
    protected int pos;
    ...
    /**
     * Creates a <code>RandomByteInputStream</code> of the specified <code>length</code>.
     * 
    ...
    /**
     * Reads up to <code>len</code> bytes of data into an array of bytes from this input stream. If <code>pos</code>
     * equals <code>count</code>, then <code>-1</code> is returned to indicate end of file. Otherwise, the number
     * <code>k</code> of bytes read is equal to the smaller of <code>len</code> and <code>count-pos</code>. If
     * <code>k</code> is positive, then k bytes are copied into <code>b[off]</code> through <code>b[off+k-1]</code> in
     * the manner performed by <code>System.arraycopy</code>. The value <code>k</code> is added into <code>pos</code>
     ...
     * <code>n</code> and <code>count-pos</code>. The value <code>k</code> is added into <code>pos</code> and
     ...
     * <code>RandomByteInputStream</code> always returns <code>false</code>.
     * 
     */
    ...
    /**
     * The <code>mark</code> method of <code>RandomByteInputStream</code> always throws an
    ...
    /**
     * The <code>reset</code> method of <code>RandomByteInputStream</code> always throws an
     * <code>UnsupportedOperationException</code>.
     * 
     */
    ...
    /**
     * Closing a <tt>RandomByteInputStream</tt> has no effect. The methods in this class can be called after the stream
