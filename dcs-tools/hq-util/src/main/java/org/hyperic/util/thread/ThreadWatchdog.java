...
/**
 * This class is able to interrupt threads after a certain interval -- useful when threads need to have a bounded
 * runtime.
 */
@Component
public class ThreadWatchdog {
     ...
     * @param units Combines with 'delay' to give the length of time to delay
     * @param targetMsg An informational message about what the current thread is doing, used when logging an interrupt.
     */
    public InterruptToken interruptMeIn(long delay,
                                        TimeUnit units,
                                        String targetMsg)
    {
                ...
                implements Runnable
    {
        ...
        public Interruptor(Thread target,
                           String targetMsg,
                           String timeMsg) {
            _target = target;
