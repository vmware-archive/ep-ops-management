...
public class StringUtil {
    ...
    private static int skipSingleQuoted(String str,
                                        int slen,
                                        int sind) {
        int i = sind;
    ...
    private static int skipDoubleQuoted(String str,
                                        int slen,
                                        int sind) {
        int i = sind;
        int pass_next = 0;
    ...
    /**
     * Return a variant of 'str' which contains the beginning and end of the string, but places '...' in the middle to
     * limit the maximum length of the string.
     * 
     * @param str String to shorten
     * @param maxLen Maximum length of the returned string
     */
    public static String dotProximate(String str,
                                      int maxLen) {
     ...
     */
    public static boolean stringDoesNotExist(String source,
                                             String sub) {
