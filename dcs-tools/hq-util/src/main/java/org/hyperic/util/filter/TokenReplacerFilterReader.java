...
public class TokenReplacerFilterReader extends FilterReader
{
    ...
    /**
     * The buffer refresh is called every time a character is read from our internal buffer. If our index has hit the
     * end of the buffer, we refresh the data, making sure that we dont split the character buffer between token
     * boundries.
     */
