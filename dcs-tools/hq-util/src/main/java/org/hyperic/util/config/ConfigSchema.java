...
public class ConfigSchema implements Serializable {
    ...
    private static HashMap<String, Boolean> secrets = new HashMap<String, Boolean>();
    private static HashMap<String, Boolean> sensitive = new HashMap<String, Boolean>();
    ...
    /**
     * Appends the given option to the end of the options list. If the option is already part of the list then it is
    ...
    /**
     * Sets the given option as the first element of the list. If the option is already part of the list then it is
     * pulled to the first position.
     * 
     * @param option the option to add.
     */
    ...
    /**
     * Add all options to the configuration options list. Any option that already exists in the configuration options
     * list is pushed to the end. The order is as in the provided list.
     * 
    ...
    public Map<String, ConfigOption> getOptionsMap() {
        ...
        synchronized (configLock) {
            Map<String, ConfigOption> opts = new HashMap<String, ConfigOption>();
     ...
     * @return ConfigOption that matches the name param, or null if there is no such option
     */
    ...
    public byte[] encode()
        ...
        try {
            ...
            synchronized (configLock) {
                for (Iterator<ConfigOption> iterator = configOptions.iterator(); iterator.hasNext();) {
                    final ConfigOption configOption = iterator.next();
     ...
     */
    public void setDefault(String prop,
                           String value) {
        synchronized (configLock) {
