...
/**
 * <p>
 * Contains validation utility methods for different types of fields. Methods "validateRequired" and "validateEmail"
 * were "borrowed" from Jakarta's validation samples.
 * </p>
 */
public class CommonValidatorUtil {
     ...
     * @return boolean If the field isn't <code>null</code> and has a length greater than zero, <code>true</code> is
     ...
     * 
     * @param value The value validation is being performed on.
     * @return boolean If the field is an e-mail address <code>true</code> is returned. Otherwise <code>false</code>.
     */
     ...
     * @return boolean If the field contains valid data <code>true</code> is returned, otherwise <code>false</code>.
     */
    // note to-do: accept non-default regexp (as property arg?)
    public static boolean validatePrincipal(Object bean,
                                            Field field) {
        boolean valid = false;
    ...
    /**
     * Validates a password verification field which requires that the value exactly match the String value of the bean
     * property referenced by property argument 1 (probably "password").
     * 
     * @param bean containing the fields to validate.
     * @param Field object containing the property resource info.
     * 
     */
    public static boolean validatePasswordVerification(Object bean,
                                                       Field field) {
        boolean valid = false;
