...
public class InstallConfigOption extends ConfigOption implements Serializable {
    ...
    /**
     * This constructor allows you to create an InstallConfigOption and behaves pretty much like the EnumConfigOption
     * class, however it deals with ConfigOptionDisplay objects rather than raw Strings.
     */
    public InstallConfigOption(String optName,
                               String optDesc,
    ...
    public void checkOptionIsValid(String value)
        ...
        if (!valid)
            throw invalidOption("must be one of options presented below. value: " + value);
    }
