...
public class DefaultSSLProviderImpl implements SSLProvider {
    ...
    private KeyManagerFactory getKeyManagerFactory(final KeyStore keystore,
    ...
    public DefaultSSLProviderImpl(KeystoreConfig keystoreConfig,
        ...
        if (log.isDebugEnabled()) {
            log.debug("Keystore info: path:" + keystoreConfig.getFilePath() +
        ...
        try {
            ...
            sslSocketFactory = new EpopsSslSocketFactory(sslContext, getHostnameVerifier());
    ...
    private X509HostnameVerifier getHostnameVerifier() {
        return new X509HostnameVerifier() {
            private final AllowAllHostnameVerifier internalVerifier = new AllowAllHostnameVerifier();
                ...
                try {
                    ...
                    SSLPeerUnverifiedException sslPeerUnverifiedException =
                                new SSLPeerUnverifiedException("The authenticity of host '" + host +
                                            "' can't be established. Host may be unreachable.");
