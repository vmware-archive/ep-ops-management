...
public final class MathUtil {
    ...
    /**
     * Find the greatest common divisor of both <code>n</code> and <code>m</code>.
     * 
    ...
    /**
     * Find the least common multiple of <code>n</code> and <code>m</code>.
     * 
     * @param n first number
     * @param m second number
     ...
     */
    public static boolean compare(Number n1,
                                  Number n2) {
        if (n1 == n2)
            return true;
        if (n1 == null || n2 == null)
    ...
    /**
     * Clamp a value to a range. If the passed value is less than the minimum, return the minimum. If it is greater than
     * the maximum, assign the maximum. else return the passed value.
     */
