...
/**
 * a PBE String Encryptor, which marks the values it encrypts with a default prefix and postfix, which enables us later
 * on to know whether those values are encrypted or not.
 * 
 * @author yakarn
 * 
 */
public class MarkedStringEncryptor implements PBEStringEncryptor, InitializingBean {
    ...
    public MarkedStringEncryptor(String algorithm,
                                 String password,
                                 int poolsize) {
        this(poolsize);
