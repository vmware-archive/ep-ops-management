...
public abstract class ConfigOption
    ...
    private String optPlatform; // Option platform
    ...
    public ConfigOption(String optName,
                        String optDesc,
                        String defValue) {
    ...
    public void setReadonly(boolean readonly) {
        this.readonly = (readonly == true ? Boolean.TRUE : Boolean.FALSE);
    }
    ...
    public void setPlatform(String platform) {
        ...
        if (StringUtils.isNotBlank(platform)) {
            setOptional(true); // as this is mandatory only for the given platform and optional for the others
        }
    }
