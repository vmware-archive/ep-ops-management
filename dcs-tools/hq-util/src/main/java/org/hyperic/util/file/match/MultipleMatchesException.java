...
/**
 * This exception is thrown by the MatcherScanner class when it detects multiple matchselectors have matched a single
 * path. This will only be thrown if the matchconfig had its allowMultiplMatches attribute set to false.
 */
