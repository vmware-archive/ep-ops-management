...
/**
 * JDBC is a utility class of JDBC helper methods. The primary methods are JDBC.getDriverString(), which given a simple
 * database name like 'oracle' returns the full jdbc driver string 'oracle.jdbc.driver.OracleDriver'.
 */
public final class JDBC
{
    ...
    /**
     * Retrieves the JDBC Connection String for the specified driver. The end of the string including the name of the
     * database to connect to and other options must be appended to the end of the returned string before using the
     * string in a JDBC call.
     * 
     * @param driver The JDBC driver name. The name can be in full name (e.g., "COM.cloudscape.core.JDBCDriver") or
     *            short name (e.g., "cloudscape") form.
     * 
     ...
     *            short name (e.g., "cloudscape") form.
     * 
     * @return String The CMP adapter class factory name
     */
     ...
     * @param driver The JDBC driver name. The name can be in full name (e.g., "COM.cloudscape.core.JDBCDriver") or
     *            short name (e.g., "cloudscape") form.
     * @param database The database name to append to the JDBC connection string.
     * 
     * @return String The JDBC connection string.
     */
    public static String getConnectionString(String driver,
    ...
    /**
     * Retrieves the full JDBC Driver String from the database name. The database name can be a short name like
     * cloudscape or a full jdbc connection string like jdbc:cloudscape:.
     * 
     * @param database The database name.
     * 
     * @return String The full JDBC Driver String (e.g., "COM.cloudscape.core.JDBCDriver") that corresponds the the
     *         short driver name.
     */
    ...
    /**
     * Loads the JDBC driver from the driver short name (e.g., oracle) or the driver full name (e.g.,
     * oracle.jdbc.driver.OracleDriver).
     * 
     * @param driver The short or full name of the JDBC driver.
     * 
     *            throws ClassNotFoundException If the driver name does not specify a valid driver.
     */
    public static void loadDriver(String database)
     ...
     * 
     * @param e The SQLException object.
     * @param out The java.io.PrintWriter to print the to.
     * 
     ...
     * 
     * @param database The database type id.
     * 
     ...
     * @param database The database name.
     * 
     * @return int The type id of the database.
     */
