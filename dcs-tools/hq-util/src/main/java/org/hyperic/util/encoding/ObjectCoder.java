...
public class ObjectCoder {
     ...
     * <p>
     * <b>Pre-condition:</b>&nbspclsType must have a <code>serialVersionUID</code> implementation.
     * </p>
     * 
    ...
    public static final <T> T decode(final String sEncoded,
                                     Class<T> clsType)
     ...
     * @throws IOException
     */
    public static final String encode(final String sAlias,
                                      final Object obj)
        throws IOException {
        if (obj == null) {
            return null;
