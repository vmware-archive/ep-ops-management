...
public class IDGenerator {
    ...
    public synchronized long getNewID()
        throws ConfigPropertyException, SequenceRetrievalException,
        SQLException {
    ...
    private synchronized void getBatch()
        throws SequenceRetrievalException, SQLException {
    ...
    private void doAlterSequence(Connection conn)
        throws SQLException {
    ...
    private synchronized void init()
        throws ConfigPropertyException, SQLException {
    ...
    /**
     * Get the name of the table a sequence refers to assumes sequence names will follow the pattern
