...
/**
 * Class to execute processes in the background. These processes will not exit once the controlling Java process exits.
 */
public class Background {
     ...
     * @param appendOut If true, append the file with standard out, else truncate or create a new file
     * @param errFile File to send standard err from the process to
     * @param appendErr If true, append the file with standard error, else truncate or create a new file
     */
    public static void exec(String[] cmd,
                            File outFile,
                            boolean appendOut,
