...
/**
 * StrongCollection is a collection class that will only accept objects into the collection of a type specified when
 * constructing the collection. StrongCollection's are subclassed to to create a type specific collection (e.g.,
 ...
 * 
 * StrongCollection implements all of the methods of the java.util.Collection interface.
 */
public class StrongCollection extends StrongBase implements java.util.Collection
{
    protected static final String CLASS_NOT_FOUND_MSG =
                "Unexpected ClassNotFoundException. A severe class loader exception has occurred\n";
    ...
    /**
     * Constructs a StrongCollection class. This constructor is used by subclasses that are strongly typed at compile
     * time and runtime. Because this constructor is protected a subclass should provide the public constructor and
     * subclass the methods in this class that accept types.
     * 
     ...
     */
    protected StrongCollection(String coll,
                               String obj)
    ...
    /**
     * Constructs a StrongCollection class. This constructor allows you to use a strongly typed collection that is only
     ...
     * 
     * @throws ClassCastException If the specified collection is not the same type as the collection it's being added
     *             to.
     */
     ...
     * 
     * @param obj The object to test for in the collection.
     * 
     ...
     * 
     * @param obj The collection containing the element to check for.
     * 
     ...
     * 
     * @return An array that contains all of the elements in the collection.
     */
    ...
    /**
     * Returns an array containing all of the elements in the collection whose runtime type is that of the specified
     * array. The specied array must be of the type specified when the StrongCollection class was instantiated.
     * 
     * @return An array that contains all of the elements in the collection.
     * 
     * @throws ClassCastException If the array is is not of the type accepted by the collection
     */
     ...
     * 
     * @return A string with all of the elements in the collection.
     */
