...
public class HostIP {
    ...
    /**
     * Convert a string based IP address into the byte representation. Same as the other convertIP method, except that
     * ipAddr is assumed to be a regular (i.e. host) address
     */
     ...
     * @param addressType Determines which addresses are considered legal. Can be IP_HOST, IP_MULTICAST, or IP_ANY
     * @return a byte array of size 4, containing the encoded address or null indicating the ip address could not be
     *         converted
     */
    public static byte[] convertIP(String ipAddr,
                                   int addressType) {
     ...
     * @return true if the <code>ip</code> is a valid IP address, false otherwise.
     */
