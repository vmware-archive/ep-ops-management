...
public class MultiRuntimeException extends RuntimeException {
    ...
    public MultiRuntimeException(final String message,
                                 final Throwable t) {
        super(message);
        this.nestedExceptions = new ArrayList<ExceptionWrapper>();
        this.addThrowable(t);
    ...
    public String getMessage() {
        ...
        final StringBuilder builder =
                    new StringBuilder(origMsg).append(this.nestedExceptions.size()).append(
                                " Exception(s) have occured:\n");
    ...
    private final StringBuilder getMessage(final MessageType enumMessageType,
        ...
        if ((exception instanceof SQLException)) {
            ...
            do {
                ...
                if (((sqle = sqle.getNextException()) != null) && (sqle != t))
                    builder.append("\n---Next SQL Exception---\n");
                else
                    break;
            } while (true);
    ...
    public final void printSelfStacktrace(final PrintStream ps) {
        super.printStackTrace(ps);
    }// EOM

    public final void printSelfStacktrace(final PrintWriter pw) {
        super.printStackTrace(pw);
    }// EOM

    private final <T> void printStackTrace(final T visitor,
                                           StreamHandlerInterface<T> strategy) {
    ...
    public static final MultiRuntimeException newMultiRuntimeException(MultiRuntimeException multiException,
                                                                       final Throwable t) {
    ...
    public static final MultiRuntimeException newMultiRuntimeException(MultiRuntimeException multiException,
                                                                       final Throwable t,
                                                                       final String nestedExcpetionMessage) {
        if (multiException == null) {
            if ((t instanceof MultiRuntimeException))
                multiException = (MultiRuntimeException) t;
            else
    ...
    private static interface StreamHandlerInterface<T> {
        ...
        void printParentStackTrace(final T visitor,
                                   final MultiRuntimeException mre);

        void println(final T visitor,
                     final String line);

        void print(final T visitor,
                   final String line);

        void printStackTrace(final T visitor,
    ...
    private static final class PrintStreamHandler implements StreamHandlerInterface<PrintStream> {
        ...
        public final void println(final PrintStream visitor,
                                  final String line) {
            visitor.println(line);
        }// EOM

        public final void print(final PrintStream visitor,
                                final String line) {
            visitor.print(line);
        }// EOM

        public final void printStackTrace(final PrintStream visitor,
                                          final Throwable throwable) {
            throwable.printStackTrace(visitor);
        }// EOM

        public final void printParentStackTrace(final PrintStream visitor,
                                                final MultiRuntimeException mre) {
    ...
    private static final class PrintWriterHandler implements StreamHandlerInterface<PrintWriter> {
        ...
        public final void println(final PrintWriter visitor,
                                  final String line) {
            visitor.println(line);
        }// EOM

        public final void print(final PrintWriter visitor,
                                final String line) {
            visitor.print(line);
        }// EOM

        public final void printStackTrace(final PrintWriter visitor,
                                          final Throwable throwable) {
            throwable.printStackTrace(visitor);
        }// EOM

        public final void printParentStackTrace(final PrintWriter visitor,
                                                final MultiRuntimeException mre) {
            mre.printSelfStacktrace(visitor);
        }// EOM
    ...
    private interface MessageType {
        StringBuilder appendMessage(final Throwable t,
                                    final StringBuilder messageBuilder);
    }// EO inner interface MessageType

    final MessageType ToString = new MessageType() {
        public final StringBuilder appendMessage(final Throwable t,
                                                 final StringBuilder messageBuilder) {
    ...
    private static final class ExceptionWrapper {
        ...
        public ExceptionWrapper(final Throwable t,
                                final String message) {
            this.t = t;
