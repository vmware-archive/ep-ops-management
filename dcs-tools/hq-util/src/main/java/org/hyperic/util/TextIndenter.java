...
/**
 * A class which functions similarly to a StringBuffer, except that one can call pushIndent/popIndent to change the
 * indentation level. When the indenter encounters a newline, it automatically positions the cursor at the next line,
