...
/**
 * Maintains a list of {@link DataPoint}s which all lie within a specific time range. This class is useful for storing
 * 'the last 30 minutes of data' and rolling the oldest data points off.
 * 
 * This class relies on datapoints being placed into the collector in time-sorted order.
 */
public class TimeWindowCollector {
    ...
    /**
     * @param windowSize The size of the window (in millis) that all the encapsulated datapoints should be within.
     */
    ...
    /**
     * Returns true if data has been rolled off the back of the time-window. (i.e. removeOldPoints() has been invoked
    ...
    /**
     * Remove old datapoints. This method uses the time of the most recent datapoint as the end of the time range.
     * 
