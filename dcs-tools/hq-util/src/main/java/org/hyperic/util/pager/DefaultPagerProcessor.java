...
/**
 * The default page processor does not process any elements that you're paging. This is useful if you're only looking to
 * page through an existing collection, and you don't need to perform any transformations on the elements that are found
 * to belong in the resultant page.
 */
