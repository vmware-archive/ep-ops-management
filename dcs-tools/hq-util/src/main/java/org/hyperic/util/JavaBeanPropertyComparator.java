...
public final class JavaBeanPropertyComparator implements Comparator {
    ...
    /**
     * Construct a comparator with <code>{@link ASCENDING}</code> sort order and the given property name.
     * 
    ...
    /**
     * <p>
     * If both <code>o1</code> and <code>o2</code> have the appropriate java bean property, compare the String
     * representation of that property value on each.
     * </p>
     * 
     * <p>
     * If one of the objects has the property and the other doesn't, the one with the property will be considered "less"
     * than the one without the property. If neither object has the property, 0 will be returned.
     * </p>
     * 
     * <p>
     * If the sort order is <code>DESCENDING</code>, the value returned will be negated.
     * </p>
     * 
     * @param o1 the first java bean to compare
     * @param o2 the second java bean to compare
     * 
     * @return the value of the string-comparison of the two bean's property values
     */
    ...
    /**
     * Return true if the passed-in <code>obj</code> is the same as this.
     * 
