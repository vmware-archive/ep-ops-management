...
{
    private static final String CREATE_SEQUENCE_TABLE = "CREATE TABLE COV_SEQUENCE (NAME VARCHAR(128) PRIMARY KEY, " +
    ...
    public static void cleanupSequences(Connection conn)
        throws SQLException
    {
        ResultSet rset = null;
        Statement stmt = null;
    ...
    public static String getCreateCommand(String name,
                                          int startVal,
                                          int increment) {
    ...
    public static String getIncrementCommand(String name,
                                             int increment) {
    ...
    public static void initSequences(Connection conn)
        throws SQLException
    {
