...
/**
 * This is just like NestedException, but it's a RuntimeException. And here's a classic case for multiple inheritance -
 * or rather why RuntimeException isn't an interface. But anyway, we get around that by using containment and delegating
 * all method calls to our internal NestedException.
 */
public class NestedRuntimeException extends RuntimeException {
    ...
    class NestedEx extends NestedException {
        ...
        public NestedEx(String s) {
            super(s);
        }

        public NestedEx(Throwable t) {
            super(t);
        }
