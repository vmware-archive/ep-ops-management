...
/**
 * User's may have email addresses This class provides and validates email addresses
 * 
...
public class EmailValidator {
    ...
    public static boolean isValidEmailAddress(String email) {
         ...
         * take a deep breath
         * 
         * text%x+y_z@foo.bar.com is a valid email address but text..x@foo.bar.com is not
         * 
         * This is derived (the escapes were tweaked to deal with Java's string parser) from Jeffrey Friedl's email
         * pattern described in his O'Reilly book "Mastering Regular Expressions"
         * 
         * It is believed to be the pattern that really checks for RFC 822 syntax compliance. Now, there are probably a
         * lot of MTA's that choke on some of the things that RFC 822 allows but for now, let's go with it.
         * 
         */
        String rfc822string =
                    "[\\040\\t]*(?:\\([^\\\\\\x80-\\xff\\n\\015()]*(?:(?:\\\\[^\\" +
    ...
    /**
     * Simple check. Just make sure there is -- only 1 '@' sign -- no whitespace -- some text before the '@' sign --
     * some text after the '@' sign -- a dot after the '@' sign -- a TLD after that.
     */
    public static boolean isValidSimpleEmail(String email) {
        ...
        if (atSignIndex == -1)
            return false;
        if (email.lastIndexOf('@') != atSignIndex)
            return false;
