...
/**
 * Abstract base class for firt class appdef resource types. This was carbon copied from Soltero's AppdefResourceValue
 * equivalent because 75% of it is the same.
 * 
 * The accessors provided in this class represent what the UI model labels "General Properties". Any other attribute is
 * assumed to be specific to the resource type.
 * 
 * 
 */
