...
public class AgentRemoteValue implements GenericValueMap, Externalizable {
     ...
     * 
     * @param vals a map of key/value pairs to add
     */
    ...
    public Map<String, String> getPrefixedValues(final String keyPrfeix) {
        Map<String, String> filtered = new HashMap<String, String>();
        for (Entry<String, String> entry : vals.entrySet()) {
            if (entry.getKey().startsWith(keyPrfeix)) {
    ...
    private void writeChunkedValues(String key,
                                    String val,
                                    DataOutput os)
        throws IOException {
