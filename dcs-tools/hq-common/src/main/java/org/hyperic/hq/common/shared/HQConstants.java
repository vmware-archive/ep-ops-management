...
public class HQConstants {
    ...
    public static final String SCHEMA_MOD_IN_PROGRESS = " *** UPGRADE IN PROGRESS: migrating to version ";
    ...
    public static final String PRODUCT = "server";
    ...
    public static final String DEFAULT_IF_EMPTY = "(empty)";

    public static final int DEFAULT_SSL_PORT = 443;

    public static final String RESOURCE_NAME_DELIM = " - ";
}
