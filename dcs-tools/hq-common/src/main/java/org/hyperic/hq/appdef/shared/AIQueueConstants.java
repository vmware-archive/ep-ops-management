...
public class AIQueueConstants {
    ...
    public static final String[] Q_DECISIONS = { "defer", "approve", "ignore", "unignore", "purge" };
    ...
    public static String getPlatformDiffString(int qstat,
                                               long diff) {
        // XXX hard-coded english string constants here
        String diffString = "";
    ...
    public static String getIPDiffString(int qstat,
                                         long diff) {
        // XXX hard-coded english string constants here
        String diffString = "";
        if (qstat == AIQueueConstants.Q_STATUS_ADDED) {
    ...
    public static String getServerDiffString(int qstat,
                                             long diff) {
        // XXX hard-coded english string constants here
        String diffString = "";
        if (qstat == AIQueueConstants.Q_STATUS_ADDED) {
