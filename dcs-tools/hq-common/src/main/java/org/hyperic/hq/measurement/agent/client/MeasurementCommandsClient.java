...
public interface MeasurementCommandsClient {
    ...
    /**
     * Schedule a group of measurements on the agent. This routine cannot fail for the inability to schedule any
     * individual measurements. The only errors which can occur are protocol or connection errors.
     * 
     ...
     * @throws AgentConnectionException indicating an error in communication with the agent.
     */
    void scheduleMeasurements(ScheduleMeasurements_args args)
        throws AgentRemoteException, AgentConnectionException;

    /**
     * Unschedule a group of previously scheduled measurements. An attempt will be made to unschedule all measurements
     * passed, however, if one client ID is unable to be unscheduled, an exception will be thrown at the end of the
     * operation. Therefore, it is safe to assume that all clientIDs passed will be unscheduled, regardless of the
     * exception.
     * 
     * @param args The collection of arguments to send to the remote Agent.
     * 
     * @throws AgentRemoteException indicating an error unscheduling or protocol problem.
     * @throws AgentConnectionException indicating an error in communication with the agent.
     */
    ...
    void removeTrackPlugin(String id,
                           String pluginType)
        throws AgentRemoteException, AgentConnectionException;

    void scheduleTopn(ScheduleTopn_args args)
        throws AgentRemoteException, AgentConnectionException;
