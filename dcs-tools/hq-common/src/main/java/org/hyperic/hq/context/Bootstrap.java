...
public class Bootstrap {
    ...
    /**
     * Sets the {@link ApplicationContext} subsequent to disposing of an existing context.
     * 
     ...
     * @param bean The bean
     */
    public static void setBean(String name,
                               Object bean) {
     ...
     * @param bean The bean
     */
    public static void setBean(Class<?> beanClass,
                               Object bean) {
