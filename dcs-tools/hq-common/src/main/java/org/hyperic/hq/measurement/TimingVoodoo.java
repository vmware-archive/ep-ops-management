...
public final class TimingVoodoo {
    /**
     * Given the approximate time associated with a data point and the interval at which that adta point is being
    ...
    public static long roundDownTime(long approxTime,
                                     long interval) {
        return roundDownTime(approxTime, interval, 0);
    }
    ...
    /**
     * Given the approximate time and interval, round the time up to the nearest timestamp that coincides with the
     * interval.
     * 
    ...
    /**
     * Compute the upper and lower bound that should be used in the SQL query for finding the collected data points
     * based on the approximate time they were taken and the interval.
     * 
    ...
    /**
     * Compute the upper and lower bound that should be used in the SQL query for finding the collected data points
     * based on the approximate time they were taken, the interval and how many intervals ago the data was collected.
     * 
     * @param approxTime the approximate time the data points were collected
     * @param interval the collection interval
     * @return an array of size 3: the upper and lower bound, and the exact interval time considering backTicks
     */
    ...
    /**
     * Compute the upper and lower bound that should be used in the SQL query for finding the collected data points
     * based on the approximate time they were taken, the interval and how many intervals of data are being considered
