...
public class MeasTabManagerUtil {
    ...
    public static MeasRange[] getMetricRanges(long begin,
                                              long end) {
     ...
     */
    public static String[] getMetricTables(long begin,
                                           long end) {
        List<MeasRange> ranges = MeasRangeObj.getInstance().getRanges();
    ...
    public static String getMeasInStmt(Collection<Integer> measIds,
                                       boolean prependAnd) {
        if (measIds.isEmpty()) {
            return "";
        }
    ...
    public static String getMeasInStmt(Integer[] measIds,
                                       boolean prependAnd) {
        if (measIds.length == 0) {
            return "";
        }
    ...
    private static int getDayOfPeriod(Calendar cal,
                                      long timems) {
        int rtn = 0;
        cal.clear();
    ...
    public static String getMeasTabname(Calendar cal,
                                        long timems) {
    ...
    public static long getMeasTabEndTime(Calendar cal,
                                         long timems) {
        cal.clear();
        cal.setTime(new java.util.Date(timems));
    ...
    public static long getMeasTabStartTime(Calendar cal,
                                           long timems) {
        cal.clear();
        cal.setTime(new java.util.Date(timems));
        int incr = 24 / NUMBER_OF_TABLES_PER_DAY;
    ...
    public static long getPrevMeasTabTime(Calendar cal,
                                          long timems) {
        cal.clear();
        cal.setTime(new java.util.Date(timems));
        long rtn = -1;
    ...
    public static List<Integer> getMeasIdsFromTemplateIds(Connection conn,
                                                          Integer[] tids)
        throws SQLException {
    ...
    public static List<Integer> getMeasIds(Connection conn,
                                           Integer[] tids,
                                           Integer[] iids)
        throws SQLException {
        List<Integer> rtn = new ArrayList<Integer>();
            ...
            do {
                ...
                if (prevTable != null && prevTable.equals(currTable)) {
                    ...
                    System.exit(1);
                            ...
                            && (currday != ((NUMBER_OF_TABLES / NUMBER_OF_TABLES_PER_DAY) - 1) && prevday == 0) ||
