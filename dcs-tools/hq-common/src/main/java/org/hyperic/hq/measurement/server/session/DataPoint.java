...
/**
 * This object encapsulates all the information needed to call {@link DataManagerImpl#addData(java.util.List, boolean)
...
public class DataPoint implements Serializable {
    ...
    public DataPoint(Integer measurementId,
