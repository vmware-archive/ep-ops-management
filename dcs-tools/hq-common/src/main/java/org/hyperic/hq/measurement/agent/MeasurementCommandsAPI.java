...
public final class MeasurementCommandsAPI extends AgentAPIInfo {
    ...
    public static final String command_unscheduleMeasurementsById =
                commandPrefix + "unscheduleMeasurementsById";
    ...
    public static final String[] commandSet = {
                ...
                command_unscheduleMeasurementsById,
                command_getMeasurements,
                command_setProperties,
                command_deleteProperties,
                command_trackAdd,
                command_trackRemove,
                command_scheduleTopn,
                command_unscheduleTopn
    };
