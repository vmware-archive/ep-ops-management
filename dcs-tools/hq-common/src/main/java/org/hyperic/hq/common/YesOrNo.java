            ...
            extends HypericEnum
{
     ...
     * @return <code>YesOrNo.YES</code> if the case insensitive trimmed string value is <code>y</code> or
     *         <code>yes</code>; otherwise return <code>YesOrNo.NO</code>.
     */
