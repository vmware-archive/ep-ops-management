            ...
            extends AgentRemoteValue
{
        ...
        throws AgentRemoteException
    {
        ...
        for (int i = 0; i < nmeas; i++) {
            ...
            ival = args.getValueAsLong(ScheduleMeasurements_args.
                        PARAM_INTERVAL + i);
            derID = args.getValueAsLong(ScheduleMeasurements_args.
                        PARAM_DERIVED_ID + i);
            dsnID = args.getValueAsLong(ScheduleMeasurements_args.
                        PARAM_DSN_ID + i);
            category = args.getValue(ScheduleMeasurements_args.
                        PARAM_CATEGORY + i);
            units = args.getValue(ScheduleMeasurements_args.
                        PARAM_UNITS + i);
    ...
    public void addMeasurement(String dsn,
                               long interval,
                               long derivedID,
                               long dsnID,
                               String category,
                               String units)
    {
        ...
        super.setValue(ScheduleMeasurements_args.PARAM_CATEGORY + curMeas,
                    category);
        super.setValue(ScheduleMeasurements_args.PARAM_UNITS + curMeas, units);
    ...
    private String getUnits(int measNum) {
        ...
        String qval = ScheduleMeasurements_args.PARAM_UNITS + measNum;
