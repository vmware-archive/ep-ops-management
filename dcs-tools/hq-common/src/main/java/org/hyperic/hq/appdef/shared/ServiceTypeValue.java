            ...
            implements java.io.Serializable
{
    ...
    private boolean isInternalHasBeenSet = false;
    ...
    public ServiceTypeValue(ServiceTypeValue otherValue)
    {
        ...
        pluginHasBeenSet = true;
        this.isInternal = otherValue.isInternal;
        isInternalHasBeenSet = true;
    ...
    public String toString()
    {
        ...
        str.append("name=" + getName() + " " + "sortName=" + getSortName() + " " + "description=" + getDescription()
                    + " " + "plugin=" + getPlugin() + " " + "isInternal=" + getIsInternal() + " " + "id=" + getId()
    ...
    public boolean isIdentical(Object other)
    {
        if (other instanceof ServiceTypeValue)
        {
            ...
            lEquals = lEquals && this.isInternal == that.isInternal;
            if (this.mTime == null)
            {
