...
public final class AppdefEntityConstants {
    ...
    public static final String HQ_AGENT_PROTOTYPE_NAME = "EP Ops Agent";
    ...
    public static boolean isGroupAdhoc(int grpType) {
        return (grpType ==
                    ...
                    grpType ==
                    AppdefEntityConstants.APPDEF_TYPE_GROUP_ADHOC_GRP || grpType == AppdefEntityConstants.APPDEF_TYPE_GROUP_ADHOC_PSS);
    }

    public static boolean isGroupCompat(int grpType) {
        return (grpType == AppdefEntityConstants.APPDEF_TYPE_GROUP_COMPAT_PS || grpType == AppdefEntityConstants.APPDEF_TYPE_GROUP_COMPAT_SVC);
    }
