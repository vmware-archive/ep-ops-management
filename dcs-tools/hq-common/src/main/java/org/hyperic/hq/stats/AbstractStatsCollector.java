...
public abstract class AbstractStatsCollector {
    ...
    protected abstract ScheduledFuture<?> scheduleAtFixedRate(Runnable runnable,
                                                              long seconds);
    ...
    public void addStat(final long value,
                        final String id) {
        if (!hasStarted.get()) {
            return;
        }
    ...
    protected class MBeanCollector implements StatCollector {
        ...
        protected MBeanCollector(String id,
                                 String objectName,
                                 String[] names,
                                 String attrName,
                                 boolean trend) {
        ...
        private final long getComposite(String name)
            throws StatUnreachableException, AttributeNotFoundException,
