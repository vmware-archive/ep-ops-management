...
public class AgentUpgradeManager {
    ...
    /**
     * Request a JVM stop if in Java Service Wrapper mode
     */
     ...
     * @throws IOException
     */
    public static boolean upgrade(String newBundle)
        throws IOException {
        return upgradePropertiesFile(newBundle);
    }

    // copies the current bundle
    private static boolean upgradePropertiesFile(String newBundle)
        throws IOException {
    ...
    private static boolean rollbackPropertiesFile()
        throws IOException {
        Properties props = getRollbackProperties();
    ...
    private static void setCurrentBundle(Properties props,
                                         String bundleHome) {
    ...
    private static void setJavaHome(Properties props,
                                    String javaHome) {
        props.setProperty(AgentConfig.JSW_PROP_AGENT_JAVA_HOME, javaHome);
    }

    private static void setRollbackBundle(Properties props,
                                          String rollbackHome) {
    ...
    private static Properties getRollbackProperties()
        throws IOException {
     ...
     */
    public static List<String> updatePlugins(Properties bootProps)
        throws IOException {
    ...
    private static void removePlugin(String child,
                                     String tmpDir,
                                     String pluginsDir,
        ...
        targetJar.delete();
        log.info("Removed plugin: " + targetJar.toString());
        tmpJar.delete();
    }

    private static void movePlugin(String child,
                                   String tmpDir,
                                   String pluginsDir,
                                   List<String> updatedPlugins)
        throws IOException {
