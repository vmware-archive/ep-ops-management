...
package org.hyperic.hq.livedata.agent;

import org.hyperic.hq.agent.AgentAPIInfo;

public class LiveDataCommandsAPI extends AgentAPIInfo {
    ...
    public static final String command_getData =
                "hyperic.livedata.getData";

    public static final String[] commandSet = {
                command_getData
    };

    public LiveDataCommandsAPI() {
