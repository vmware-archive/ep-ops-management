            ...
            implements java.io.Serializable
{
    ...
    public String toString()
    {
        ...
        str.append("queueStatus=" + getQueueStatus() + " " + "diff=" + getDiff() + " " + "ignored=" + getIgnored()
                    + " " + "address=" + getAddress() + " " + "mACAddress=" + getMACAddress() + " " + "netmask="
                    + getNetmask() + " " + "id=" + getId() + " " + "mTime=" + getMTime() + " " + "cTime=" + getCTime());
        str.append('}');
