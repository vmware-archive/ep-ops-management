            ...
            implements java.io.Serializable
{
    ...
    public void setAutoinventoryIdentifier(java.lang.String autoinventoryIdentifier)
    {
        if (autoinventoryIdentifier != null) {
            autoinventoryIdentifier = autoinventoryIdentifier.trim();
        }
        this.autoinventoryIdentifier = autoinventoryIdentifier;
        if (autoinventoryIdentifier != null) {
            autoinventoryIdentifierHasBeenSet = true;
    ...
    public String toString()
    {
        ...
        str.append("queueStatus=" + getQueueStatus() + " " + "customProperties=" + getCustomProperties() + " "
                    + "productConfig=" + getProductConfig() + " " + "controlConfig=" + getControlConfig() + " "
                    + "measurementConfig=" + getMeasurementConfig() + " " + "responseTimeConfig="
                    + getResponseTimeConfig() + " " + "diff=" + getDiff() + " " + "ignored=" + getIgnored() + " "
                    + "serverTypeName=" + getServerTypeName() + " " + "name=" + getName() + " "
                    + "autoinventoryIdentifier=" + getAutoinventoryIdentifier() + " " + "installPath="
                    + getInstallPath() + " " + "description=" + getDescription() + " " + "servicesAutomanaged="
                    + getServicesAutomanaged() + " " + "id=" + getId() + " " + "mTime=" + getMTime() + " " + "cTime="
                    + getCTime());
        str.append('}');
