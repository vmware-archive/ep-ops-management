            ...
            implements java.io.Serializable
{
    ...
    public String toString()
    {
        ...
        str.append("sortName=" + getSortName() + " " + "system=" + getSystem() + " " + "groupType=" + getGroupType()
                    + " " + "groupEntType=" + getGroupEntType() + " " + "groupEntResType=" + getGroupEntResType() + " "
                    + "clusterId=" + getClusterId() + " " + "description=" + getDescription() + " " + "location="
                    + getLocation() + " " + "modifiedBy=" + getModifiedBy() + " " + "mTime=" + getMTime() + " "
                    + "cTime=" + getCTime() + " " + "name=" + getName() + " " + "id=" + getId());
        str.append('}');
