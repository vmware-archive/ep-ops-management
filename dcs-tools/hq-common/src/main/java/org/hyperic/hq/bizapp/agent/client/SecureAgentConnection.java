...
/**
 * An object which wraps an AgentConnection object, so as to provide SSL capabilities (associated with the
 * CAMServerHandler's handleConnection method)
 */
            ...
            extends AgentConnection
{
    ...
    private SecureAgentConnection(KeystoreConfig keystoreConfig,
                                  String agentAddress,
                                  int agentPort,
                                  String authToken) {
    ...
    public SecureAgentConnection(String agentAddress,
                                 int agentPort,
                                 String authToken,
        ...
        throws IOException
    {
        ...
        try {
            ...
            // In any case, it would seem as though the bug has since been fixed in IBM's JRE, no need to work around it
            // anymore...
