...
public interface AlertConditionEvaluatorStateRepository {
    /**
     * 
     * @return A Map where key is alert definition ID and value is the Serializable stored state of the
     ...
     * 
     * @return A Map where key is alert definition ID and value is the Serializable stored state of the
     *         ExecutionStrategy with that ID.
     */
     ...
     * 
     * @param alertConditionEvaluatorStates A Map where key is alert definition ID and value is the Serializable state
     *            of the AlertConditionEvaluator with that ID.
     */
     ...
     * 
     * @param executionStrategyStates A Map where key is alert definition ID and value is the Serializable state of the
     *            ExecutionStrategy with that ID.
     */
