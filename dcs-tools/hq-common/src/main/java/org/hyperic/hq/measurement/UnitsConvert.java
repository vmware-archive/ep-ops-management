...
public class UnitsConvert {
    ...
    /**
     * Return the corresponding unit constant from <code>UnitsConstants</code> for the given unit.
     * 
     * @param unit the unit
    ...
    /**
     * Return the corresponding scale constant from <code>UnitsConstants</code> for the given unit.
     * 
     * @param unit the unit
     ...
     * 
     * Example: If 1, 100, 1000, 10000 are the values passed and the units == UNITS_BYTES, the following is returned
     * 
     ...
     * @param locale The locale to use when rendering the result
     * 
     * @return An array of FormattedNumber[] objects which represent the formatted value for each corresponding value in
     *         'vals'
     */
