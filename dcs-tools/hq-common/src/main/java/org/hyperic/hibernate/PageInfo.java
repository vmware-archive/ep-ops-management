...
public class PageInfo {
    ...
    private PageInfo(SortField sort,
                     boolean ascending) {
        _isAll = true;
        _sort = sort;
        _ascending = ascending;
    ...
    /**
     * Modifies a Hibernate query to conform to the paging specs in this PageInfo object. This only changes this method
     * makes are to the page offset and result count. Sort order must be dealt with elsewhere.
     */
