...
public interface HibernateInterceptorChain {
    ...
    Boolean isTransient(HibernateInterceptorChain next,
                        Interceptor target,
                        Object entity);

    Object instantiate(HibernateInterceptorChain next,
                       Interceptor target,
                       String entityName,
    ...
    String getEntityName(HibernateInterceptorChain next,
                         Interceptor target,
                         Object object);

    Object getEntity(HibernateInterceptorChain next,
                     Interceptor target,
                     String entityName,
                     Serializable id);
