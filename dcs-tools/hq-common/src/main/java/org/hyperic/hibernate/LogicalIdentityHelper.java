...
/**
 * A utility class for checking equality and generating hash codes for persisted objects that use a numeric primary key
 * as their logical identifier.
 */
class LogicalIdentityHelper {
     ...
     */
    public static boolean equals(PersistedObject thisObject,
                                 Object toCheck) {
     ...
     * @return <code>true</code> if the object to check is equal to this object.
     */
    public static boolean equals(LongIdPersistedObject thisObject,
                                 Object toCheck) {
        if (thisObject == toCheck) {
            return true;
        }
    ...
    private static boolean equals(Number thisObjectId,
                                  Number toCheckObjectId) {
