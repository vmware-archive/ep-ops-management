 ...
 * 
 * Some of these methods are marked as protected. This allows Hibernate to pull & set values (due to its fancy runtime
 * subclassing), but also restricts other rogue objects from doing bad things like setting the ID & version #.
 * 
