...
/**
 * The ComboGenerator dispatches to either a sequence-based generator or a HQMultipleHiLoPerTableGenerator, depending on
 * whether or not the DB supports sequences.
 */
