...
/**
 * DBInfo is a tool for printing information about a given JDBC driver and database
 * 
 * DBInfo can be run from the command line using the command: java org.hyperic.tools.db.DBPing The DBInfo class and your
 * JDBC driver should be in your classpath.
 * 
 * DBInfo can also be called directly from another class. To do this instantiate the DBInfo class and then call the
 * DBPing.printInfo() method.
 */
public class DBInfo
{
     ...
     * 
     * @return boolean true if the JDBC driver loaded and connected to the database, false otherwise.
     */
    public void printInfo(String driver,
                          String database)
        ...
        throws ClassNotFoundException, SQLException
    {
        ...
        try
        {
            ...
            out.println("  Default Transaction Isolation      : "
                        + DBInfo.transactionIsolationToString(data.getDefaultTransactionIsolation()));
            ...
            out.println("  Data Definition and Data Manipulation Transactions: "
                        + data.supportsDataDefinitionAndDataManipulationTransactions());
            out.println();
