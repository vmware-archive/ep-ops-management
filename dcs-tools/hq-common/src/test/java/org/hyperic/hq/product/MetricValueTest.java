...
public class MetricValueTest extends TestCase {
    ...
    /**
     * If the timestamp is not specified and set to the current system time then it's next to impossible to guarantee
     * logical equality.
     */
    public void testEqualsTimestampNotSpecified()
        throws Exception {
        long value = 1000;
    ...
    /**
     * With the value and timestamp specified, you should be able to predict equality and comparable values.
     */
    ...
    /**
     * The exact same instance of MetricValue.NONE should be equal to itself and compareTo() should = zero.
     */
    ...
    /**
     * Two different metric values both with MetricValue.VALUE_NONE are considered to be equal if their timestamps are
     * the same, but if their timestamps are different, they are not equal.
     */
    public void testEqualsDifferentInstanceOfMetricValueNone()
        throws Exception {
    ...
    /**
     * The exact same instance of MetricValue.FUTURE should be equal to itself and compareTo() should = zero.
     */
    ...
    /**
     * Two different metric values both with MetricValue.VALUE_FUTURE are considered to be equal if their timestamps are
     * the same, but if their timestamps are different, they are not equal.
     */
    public void testEqualsDifferentInstanceOfMetricValueFuture()
        throws Exception {
        long timestamp1 = 1000;
        long timestamp2 = 2000;
