 ...
 */
public class AppdefEntityIDTest extends TestCase {
     ...
     * @param name
     */
    public AppdefEntityIDTest(String name) {
        super(name);
    }

    /**
     * To address HHQ-1456, we had to introduce custom serialization for AppdefEntityID instances to provide a migration
     * path for instances serialized in an HQ 3.1.x instance and deserialized in an HQ 3.2 instance. Let's make sure the
     * serialization works for instances serialized and deserialized in HQ 3.2.
     */
