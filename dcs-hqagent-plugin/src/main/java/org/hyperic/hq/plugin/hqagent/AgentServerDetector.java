    ...
    implements AutoServerDetector
{
    ...
    public List getServerResources(ConfigResponse platformConfig) throws PluginException
    {
        ...
        String platformDisplayName = getPlatformDisplayedName(platformConfig);
        String agtName = getAgentName(platformDisplayName);
    ...
    private String getPlatformDisplayedName(ConfigResponse platformConfig) {
        return platformConfig.getValue(ProductPlugin.PROP_PLATFORM_DISPLAY_NAME);
    }

    private String getAgentName(String platformDisplayName) {
        String agtName = AppdefEntityConstants.HQ_AGENT_PROTOTYPE_NAME;
        return agtName + HQConstants.RESOURCE_NAME_DELIM + platformDisplayName;
    }
