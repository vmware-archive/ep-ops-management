            ...
            implements AutoServerDetector, RuntimeDiscoverer
{
    ...
    protected abstract ArrayList getSystemServiceValues(Sigar sigar,
    ...
    protected String getServerName() {
        if (this.name == null) {
            this.name = ServiceResource.SERVER_NAME_PLACEHOLDER;
        }
    ...
    protected String getFullServiceName(String name) { // TODO: remove if services prefix are not needed
        return /* prefix should go here + */name;
    }
