 ...
 * <br/>
 * The class is defined as the product sub plugin the hq-plugin.xml file. <br/>
...
public class SystemPluginProxy extends ProductPlugin {
     ...
     */
    @Override
    public final void init(final PluginManager manager)
        ...
        try {
            ...
            if (is != null) {
                try {
                    ...
                    final Class<? extends SystemPlugin> customCls =
                                (Class<? extends SystemPlugin>) Class.forName(classNameBuilder.toString());
    ...
    @Override
    public final ConfigSchema getConfigSchema(final TypeInfo info,
    ...
    @Override
    public final GenericPlugin getPlugin(final String type,
                                         final TypeInfo info) {
    ...
    @Override
    public final void configure(final ConfigResponse config)
        throws PluginException {
