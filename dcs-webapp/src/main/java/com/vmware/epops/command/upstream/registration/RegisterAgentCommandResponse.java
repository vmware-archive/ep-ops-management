...
public class RegisterAgentCommandResponse extends AgentCommandResponseBase {
    ...
    public void setCertificate(String pemEncodedCertificate1) {
        this.pemEncodedCertificate = pemEncodedCertificate1;
    }
}
