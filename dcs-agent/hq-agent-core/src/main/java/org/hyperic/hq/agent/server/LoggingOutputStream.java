...
//copyof: log4j/tags/v1_2_15/contribs/JimMoore/LoggingOutputStream.java
package org.hyperic.hq.agent.server; //XXX .util ?
...
public class LoggingOutputStream extends OutputStream {
     ...
     */
    public LoggingOutputStream(Category cat,
                               Priority priority)
