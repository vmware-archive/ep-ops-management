...
/**
 * The object which manages all libraries wanting to have their commands remotely dispatched. Libraries can register
 * their server handler with a CommandDispatcher, and when a request is processed, their registered methods will be
 * invoked.
 */
public class CommandDispatcher {
    ...
    /**
     * Register a server handler with the dispatcher. The server handler will be queried as to what commands it knows
     * about, and that information will be saved locally.
     * 
     * @param handler an object implementing the AgentServerHandler interface
     * 
     ...
     */
    public AgentRemoteValue processRequest(AgentCommand cmd,
        ...
        try {
            ...
            if (log.isDebugEnabled()) {
                log.debug("processing cmd=" + cmd.getCommand());
            }
