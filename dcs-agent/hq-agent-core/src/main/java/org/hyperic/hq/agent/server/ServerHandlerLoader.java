...
/**
 * The ServerHandlerLoader utilizes the ComponentLoader to load .jars which are to be plugged into the Agent's
 * AgentServerHandler interface. This object is a bit of a machine which takes paths to .jars, and returns the
 * AgentServerHandler object associated with the main-class in the .jar.
 */
...
class ServerHandlerLoader {
    ...
    /**
     * Load a .jar into the VM and return the requested AgentServerHandler. This routine loads the .jar, extracts the
     * Main-Class, verifies that it implements the correct interface, and returns it to the caller.
     * 
     * @param jarPath path to the .jar file
     * 
     * @return an AgentServerHandler object as implemented by the Main-Class in the .jar
     * 
     * @throws AgentLoaderException indicating there was an error loading the class.
     */
    ...
    private void validateServerHandler(Object sHandler,
                                       String sHandlerName)
        throws AgentLoaderException
    {
        Class tc;
