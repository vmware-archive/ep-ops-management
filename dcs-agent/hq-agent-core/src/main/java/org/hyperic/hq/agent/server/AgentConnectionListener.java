...
/**
 * The AgentConnectionListener is an interface for plugins which wish to handle incoming connections & pass them off to
 * the agent.
 */
public abstract class AgentConnectionListener {
     ...
     * @throws InterruptedIOException if a timeout occurred waiting for the connection
     */
