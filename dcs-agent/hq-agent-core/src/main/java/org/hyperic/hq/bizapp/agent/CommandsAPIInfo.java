            ...
            extends AgentAPIInfo
{
    ...
    public static final String command_notifyKeystoreChanged =
                commandPrefix + "notify";
    public static final String[] commandSet = {
                command_setServer,
                command_getServer,
                command_createToken,
                command_getTokens,
                command_notifyKeystoreChanged,
    };
    ...
    public static ProviderInfo getProvider(AgentStorageProvider storage) {
        ...
        return new ProviderInfo(providerAddress, agentToken, secureCommunicationPort);
    }
                                   ...
                                   ProviderInfo provider)
    {
        if (provider != null) {
            ...
            storage.setValue(PROP_UNIDIRECTIONAL_PORT,
                        String.valueOf(provider.getProviderPort()));
