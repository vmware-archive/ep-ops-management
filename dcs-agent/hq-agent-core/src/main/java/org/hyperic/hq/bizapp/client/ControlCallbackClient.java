...
public class ControlCallbackClient extends AgentCallbackClient
{
    ...
    public ControlSendCommandResult_args newResultsMetadata(String pluginName,
                                                            int id,
                                                            long startTime) {
    ...
    public void controlSendCommandResult(String pluginName,
                                         int id,
                                         int result,
                                         long startTime,
                                         long endTime,
