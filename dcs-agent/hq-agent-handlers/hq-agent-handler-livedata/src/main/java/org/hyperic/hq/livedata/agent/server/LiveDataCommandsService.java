...
public class LiveDataCommandsService implements LiveDataCommandsClient {
    ...
    /**
     * @see org.hyperic.hq.livedata.agent.client.LiveDataCommandsClient#getData(org.hyperic.hq.appdef.shared.AppdefEntityID,
    ...
    LiveData_result getData(LiveData_args args)
