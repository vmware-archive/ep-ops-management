...
public class ScheduleThreadTest extends TestCase {
    ...
    private ScheduledMeasurement createMeasurement(String dsn,
                                                   long interval) {
    ...
    public void testSimpleStartKill()
        ...
        ScheduleThread st = new ScheduleThread(new SimpleSender(), new Properties(), null);
    ...
    public void testCollectionMultiDomain()
        throws Exception {
    ...
    public void testCollectionMultiDomainHangCollection()
        throws Exception {

        Properties p = new Properties();
        p.put(ScheduleThread.PROP_CANCEL_TIMEOUT, "500");

        ScheduleThread st = new ScheduleThread(new SimpleSender(), p, null);
    ...
    public static class SimpleValueGetter implements MeasurementValueGetter {
        ...
        public GenericPlugin getPlugin(String plugin)
