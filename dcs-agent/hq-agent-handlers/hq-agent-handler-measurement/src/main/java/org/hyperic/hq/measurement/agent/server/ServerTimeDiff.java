...
/**
 * This class holds the time offset between the agent and the server, used for deducting the timestamp of metric values
 * in case the agent and the server clock are not synced - Should prevent the problem that agents are sending metric
 * data to the server but users don't see anything in the UI.
 * 
 */
