            ...
            extends AgentConnectionListener
{
    ...
    private SSLServerConnection handleNewConn(SSLSocket sock)
        ...
        try {
            ...
            throw new AgentConnectionException("There was an error negotiating the auth: " +
                        exc.getMessage(), exc);
        }
    ...
    public void setup()
        ...
        try {
            ...
            throw new AgentStartException("Failed to setup listen socket: unknown host", exc);
        }
        ...
        while (true) {
            try {
                ...
                log.warn("Failed to listen at port "
     ...
     * @return
     */
    private String[] getSupportedAndEnabledCiphers(List<String> enabledCiphers,
