...
/**
 * Class to run control actions. Control actions should happen infrequently enough that the simplicity of spawning a new
 * thread each time should outweigh the performance benefits of using a thread pool. We can always modify this behavior
 * later.
 */
class ActionThread extends Thread {
    ...
    ActionThread(String pluginName,
                 String pluginType,
                 String id,
                 String action,
                 String[] args,
